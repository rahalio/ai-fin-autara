/**
 * Explanations Services - Application Layer Export
 *
...
/**
 * Explanations Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for explanations domain.
 */
