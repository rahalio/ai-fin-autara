/**
 * Proposals Services - Application Layer Export
 *
...
/**
 * Proposals Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for proposals domain.
 */
