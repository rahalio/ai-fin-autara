/**
 * Outcomes Services - Application Layer Export
 *
...
/**
 * Outcomes Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for outcomes domain.
 */
